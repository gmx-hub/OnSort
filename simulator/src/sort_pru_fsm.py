...
## pru unit fsm class simulate the behavior of prefetch read unit(PRU) fsm module in hardware
class sort_pru_fsm:
    def __init__(self):
    ...
    def pru_fsm_prefetch_func(self,
        ...
        [sbu2pru_rd_vld,
         sbu2rud_rd_addr,
         sbu2pru_rd_data] = self.sbu.sort_sbu_rd_func(pru2sbu_rd_vld,pru2sbu_rd_addr)
        ...
        self.sbu.sort_sbu_wr_func(agu2pru_sbu_wr_vld_i,agu2pru_sbu_wr_addr_i)
    ...
    def pru_fsm_without_prefetch_func(self,
        ...
        if(cur_state_cnt_mem_en == 1): ## state rd cnt_mem 
            ...
            if (next_state_cnt_mem_en):
                ...
                pru_fsm_done_vld        = 1
                reg_nprefetch_mem_cnt_d = self.para_nprefetch_mem_cnt_max_val #if (ctrl2pru_config_oder_en_i ==1) else 0
            else:
